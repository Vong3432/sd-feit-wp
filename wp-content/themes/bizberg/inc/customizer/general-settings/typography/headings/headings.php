...
Kirki::add_field( 'bizberg', [
	...
	'output'      => [
		[
			'element' => 'h1:not([class^="elementor-"]):not(.banner-title),.breadcrumb-wrapper h1',
		],
	],
	'active_callback' => [
		[
...
Kirki::add_field( 'bizberg', [
	...
	'output'      => [
		[
			'element' => 'h2:not([class^="elementor-"]):not(.title),#sidebar .widget h2.widget-title',
		],
	],
	'active_callback' => [
		[
...
Kirki::add_field( 'bizberg', [
	...
	'output'      => [
		[
			'element' => 'h3:not([class^="elementor-"]):not(.header_site_title):not([class^="eael-"]):not(.team-title),.detail-content.single_page h3',
		],
	],
	'active_callback' => [
		[
...
Kirki::add_field( 'bizberg', [
	...
	'output'      => [
		[
			'element' => 'h4:not([class^="elementor-"]):not([class^="eael-"]):not([class^="napae-"])',
		],
	],
	'active_callback' => [
		[
